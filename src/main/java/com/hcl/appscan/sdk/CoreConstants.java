...
public interface CoreConstants {
	...
	String API_SACLIENT_DOWNLOAD		= API_ENV_LATEST + "/Tools/SAClientUtilByType?toolType=%s"; 		  //$NON-NLS-1$
	String API_SACLIENT_VERSION			= API_ENV_LATEST + "/Tools/SAClientUtilByType?toolType=%s&meta=%s";   //$NON-NLS-1$
